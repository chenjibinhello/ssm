...
public class ErpPurchaseBillProperties implements Serializable {
    ...
    private Integer voucherPayablePropertyId;
    ...
    public void setMoneyPrecision(String moneyPrecision) {
        this.moneyPrecision = moneyPrecision == null ? null : moneyPrecision.trim();
    }
    ...
    public void setCheckPurchase(String checkPurchase) {
        this.checkPurchase = checkPurchase == null ? null : checkPurchase.trim();
    }
    ...
    public Integer getVoucherPayablePropertyId() {
        return voucherPayablePropertyId;
    }

    public void setVoucherPayablePropertyId(Integer voucherPayablePropertyId) {
        this.voucherPayablePropertyId = voucherPayablePropertyId;
    }
    ...
    public String toString() {
        ...
        sb.append(", checkPurchase=").append(checkPurchase);
        sb.append(", directSettleAccount=").append(directSettleAccount);
        sb.append(", voucherPayablePropertyId=").append(voucherPayablePropertyId);
